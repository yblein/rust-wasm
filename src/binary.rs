...
mod tests {
	...
	fn decode_vs32() {
		...
		decode_to(&[0x7f], -1);
		decode_to(&[0x80, 0x40], -8192);
		decode_to(&[0x80, 0xc0, 0x00], 8192);
		decode_to(&[0x80, 0x80, 0x80, 0x80, 0x78], i32::MIN);
		decode_to(&[0xff, 0xff, 0xff, 0xff, 0x07], i32::MAX);
	}
	...
	fn decode_vs64() {
		...
		decode_to(&[0x80, 0x40], -8192);
		decode_to(&[0x80, 0xc0, 0x00], 8192);
		decode_to(&[0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x7f], i64::MIN);
		decode_to(&[0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00], i64::MAX);
	}
