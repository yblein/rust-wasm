...
(assert_return
  (invoke "f32_load" (f32.const 0.0123399998993))
  (f32.const 0.0123399998993)
)
(assert_return
  (invoke "f32_load" (f32.const 4242.42431641))
  (f32.const 4242.42431641)
)
(assert_return
  (invoke "f32_load" (f32.const 3.40282346639e+38))
  (f32.const 3.40282346639e+38)
)
(assert_return (invoke "f64_load" (f64.const -1.)) (f64.const -1.))
(assert_return
  (invoke "f64_load" (f64.const 1234.56789))
  (f64.const 1234.56789)
)
(assert_return
  (invoke "f64_load" (f64.const 424242.424242))
  (f64.const 424242.424242)
)
(assert_return
  (invoke "f64_load" (f64.const 1.79769313486e+308))
...
(assert_return
  (invoke "f32_store" (f32.const 0.0123399998993))
  (f32.const 0.0123399998993)
)
(assert_return
  (invoke "f32_store" (f32.const 4242.42431641))
  (f32.const 4242.42431641)
)
(assert_return
  (invoke "f32_store" (f32.const 3.40282346639e+38))
  (f32.const 3.40282346639e+38)
)
(assert_return (invoke "f64_store" (f64.const -1.)) (f64.const -1.))
(assert_return
  (invoke "f64_store" (f64.const 1234.56789))
  (f64.const 1234.56789)
)
(assert_return
  (invoke "f64_store" (f64.const 424242.424242))
  (f64.const 424242.424242)
)
(assert_return
  (invoke "f64_store" (f64.const 1.79769313486e+308))
  (f64.const 1.79769313486e+308)
)
